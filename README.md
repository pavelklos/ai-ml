...
- **Case Studies** (End-to-End ML Projects) ⚠️(convert to Jupyter Notebooks)
  ...
  - **Medical Image Classification for Disease Detection** (008) 📗 [case-study-008-en.md](0-CASE-STUDIES/case-study-008-en.md) (get data) [008a-en-data.md](0-CASE-STUDIES/008a-en-data.md)
